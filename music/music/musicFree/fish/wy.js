...
function formatMusicItem(_) {
    ...
    return {
        ...
        url: `https://m-api.ceseet.me/url/wy/${_.id}/128k`,
        qualities: {
            low: {
...
async function getMediaSource(musicItem, quality) {
    const res = (
        await axios_1.default.get(`https://m-api.ceseet.me/url/wy/${musicItem.id}/${qualityLevels[quality]}`)
    ).data;
    return {
        url: res.data,
    };
...
module.exports = {
    ...
    srcUrl: "https://rxsub.eu.org/music/musicFree/fish/wy.js",
