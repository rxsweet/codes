...
function formatMusicItem(_) {
    ...
    return {
        ...
        url: `https://ikun.laoguantx.top:19742/QAQ//QAQ/url/wy/${_.id}/128k`,
        qualities: {
            low: {
...
async function getMediaSource(musicItem, quality) {
    const res = (
        await axios_1.default.get(`https://ikun.laoguantx.top:19742/QAQ//QAQ/url/wy/${musicItem.id}/${qualityLevels[quality]}`, {
            headers: {
...
module.exports = {
    platform: "[网易云]",
    author: 'musicDownloader',
    version: "0.0.1",
    appVersion: ">0.1.0-alpha.0",
    srcUrl: "https://rxsub.eu.org/music/musicFree/musicDownloader/wy.js",
