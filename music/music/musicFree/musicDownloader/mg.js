...
async function getMediaSource(musicItem, quality) {
    const res = (
        await axios_1.default.get(`https://ikun.laoguantx.top:19742/QAQ/url/mg/${musicItem.id}/${qualityLevels[quality]}`)
    ).data;
    return {
        url: res.data,
    };
...
module.exports = {
    ...
    cacheControl: "cache",
    srcUrl: "https://rxsub.eu.org/music/musicFree/musicDownloader/mg.js",
