...
async function getMediaSource(musicItem, quality) {
    const res = (
        await axios_1.default.get(`https://ikun.laoguantx.top:19742/QAQ/url/tx/${musicItem.songmid}/${qualityLevels[quality]}`, {
            headers: {
...
module.exports = {
    ...
    version: "0.0.1",
    srcUrl: "https://rxsub.eu.org/music/musicFree/musicDownloader/qq.js",
