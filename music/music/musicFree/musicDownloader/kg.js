...
async function getMediaSource(musicItem, quality) {
    const res = (
        await axios_1.default.get(`https://ikun.laoguantx.top:19742/QAQ/url/kg/${musicItem.id}/${qualityLevels[quality]}`, {
            headers: {
...
module.exports = {
    ...
    srcUrl: "https://rxsub.eu.org/music/musicFree/musicDownloader/kg.js",
