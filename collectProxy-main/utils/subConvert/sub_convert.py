        ...
        for line in lines:
            ...
            if 'ss://' in line and 'vless://' not in line and 'vmess://' not in line:
                ...
                try:
                    ...
                    if isinstance(password_part,int) or password_part == None or password_part == '':
                        print(f"{newname}的password为int类型纯数字或为空！")
                        continue
            ...
            if 'trojan://' in line:
                try:
                    ...
                    if isinstance(server_part_list[0],int) or server_part_list[0] == None or server_part_list[0] == '':
                        print(f"{newname}的password为int类型纯数字或为空！")
                        continue
