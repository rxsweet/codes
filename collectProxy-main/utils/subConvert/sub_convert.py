        ...
        for line in lines:
            ...
            if 'vmess://' in line:
                try:
                    ...
                    if vmess_config['id'] == '' or vmess_config['id'] is None:
                        ...
                        if vmess_config['net'] == '' or vmess_config['net'] is False or vmess_config['net'] is None or ':' in vmess_config['net']:
                        ...
                        elif vmess_config['tls'] == '' or vmess_config['tls'] is False or vmess_config['tls'] is None or ':' in vmess_config['tls']:
                            yaml_url.setdefault('tls', False)
                        else:
                            yaml_url.setdefault('tls', True)
                        yaml_url.setdefault('ws-opts', {})
                        if vmess_config['path'] == '' or vmess_config['path'] is False or vmess_config['path'] is None or ':' in vmess_config['path']:
            ...
            if 'ss://' in line and 'vless://' not in line and 'vmess://' not in line:
                ...
                try:
                    ...
                    if ':' in server_part_list[0] or ',' in server_part_list[0] or '"' in server_part_list[0] or '{' in server_part_list[0] or '}' in server_part_list[0] or '#' in server_part_list[0] or '*' in server_part_list[0] or '|' in server_part_list[0] or '(' in server_part_list[0] or ')' in server_part_list[0]:
                        print('password中出现特殊字符')
                        continue
            ...
            if 'ssr://' in line:
                ...
                try:
                    ...
                    p = password_part
                    if ':' in p or ',' in p or '"' in p or '{' in p or '}' in p or '#' in p or '*' in p or '|' in p or '(' in p or ')' in p:
                        print('password中出现特殊字符')
                        continue
                    yaml_url.setdefault('password', password_part)
