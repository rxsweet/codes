...
#源文件
source_sublist_path = './utils/collectTGsub/TGsubSources.yaml'
#爬取的TG分享的节点
crawlTGnodeAll = 'https://raw.githubusercontent.com/rxsweet/useProxies/main/sub/sources/crawlTGnodeAll'
