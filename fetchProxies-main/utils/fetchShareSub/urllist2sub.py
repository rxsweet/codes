...
#源文件
urllistfile1 = './utils/fetchShareSub/sublist'
urllistfile2 = './sub/sources/changeSubList'

#输出订阅文件位置
outputAllyaml_path = './sub/sources/fetchShareAll.yaml'
...
if __name__ == '__main__':
    ...
    urllist1 = list_to_content.get_sublist(urllistfile2)
    #合并
